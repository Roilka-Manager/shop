...
public class RegexUtils {  
	...
	/** 
	 * 正则：手机号（精确） 
	 * <p>移动：134(0-8)、135、136、137、138、139、147、150、151、152、157、158、159、171、178、182、183、184、187、188、198</p>
	 * <p>联通：130、131、132、145、155、156、166、175、176、185、186</p>
	 * <p>电信：133、149、153、173、177、180、181、189、199</p>
	 * <p>全球星：1349</p> 
	 * <p>虚拟运营商：170</p> 
	 */  
	public static final String REGEX_MOBILE_EXACT  = "^((13[0-9])|(14[5,7,9])|(15[0-3,5-9])|(17[0,1,3,5-8])|(18[0-9])|166|198|199|(147))\\d{8}$";
	/** 
	 * 正则：电话号码 
	 */  
	...
	public static final List<String> sexList = Arrays.asList(new String[] {"男","女"});
	...
	public static boolean isDateTime(CharSequence input) {
		return isMatch(REGEX_DATE_TIME, input);
	}
    ...
    public static boolean isPositiveFloat(CharSequence input) {
        return isMatch(REGEX_POSITIVE_FLOAT, input)||isMatch(REGEX_POSITIVE_INTEGER, input);  
    }
     ...
     * @return {@code true}: 匹配<br>{@code false}: 不匹配 
     */
    public static boolean isPlus(CharSequence input) {
        return isMatch(REGEX_NOT_NEGATIVE_PLUS, input);  
    }
    ...
    public static void main(String[] args) {
		System.out.println(isWords("dd爱迪生大"));
	}
}  